...
public struct ImageColors {
    ...
    public init(from uiImageColors: UIImageColors) {
        self.background = Color(uiImageColors.background)
        self.primary = Color(uiImageColors.primary)
        self.secondary = Color(uiImageColors.secondary)
        self.detail = Color(uiImageColors.detail)
    }
}
